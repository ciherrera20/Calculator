...
class Interpreter():
    ...
    def _evaluate_function_def(self, word, word_list, definition):
        ...
        user_function = Scope2.UserFunction(function_name, param_names, definition, self._scope)
    ...
    def _evaluate_function_call(self, callable, *args):
        ...
        for param_set in param_sets:
            if isinstance(value, Scope2.Function):
...
def get_global_interpreter(interface=False):
    return Interpreter(Scope2.Scope.get_global_scope(interface=interface))
